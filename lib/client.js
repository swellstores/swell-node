...
class Client extends EventEmitter {
  ...
  init(clientId, clientKey, options) {
    ...
    this.params = {
      ...
      routeClientEnv: options.route && options.route.env,
    ...
    if (this.params.routeClientEnv) {
      this.params.endClientId += `-${this.params.routeClientEnv};`
    }
